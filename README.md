...
<p align="center">
  ...
  <a href="https://hub.docker.com/r/lainsmain/mneme-server"><img alt="Docker server" src="https://img.shields.io/docker/v/lainsmain/mneme-server?label=server"></a>
...
`lainsmain/mneme-server:<version>` and `latest` images, and creates a GitHub
